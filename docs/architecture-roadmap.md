...
- remote-control domain contracts、connection/screen application policies、screen capture
  infrastructure 与 platform gateway → `lib/features/remote_control/`
...
remote-control socket owner、socket connection helpers、voice infrastructure 与 presentation，
以及 browser/video 继续按下列顺序渐进处理。
