...
| Telegram companion app support `/telegram/` TDLib data | `TelegramTdlibService` in `extensions/telegram` / TDLib | high | No | First companion use requires login; only explicit Telegram logout/data reset or companion uninstall may clear it |
